...
import { S as Subscribable, x as pendingThenable, y as resolveEnabled, z as shallowEqualObjects, D as resolveStaleTime, E as noop, H as isServer, I as isValidTimeout, J as timeUntilStale, K as timeoutManager, M as focusManager, N as fetchState, O as replaceData, P as notifyManager, Q as hashKey, U as getDefaultState, r as reactExports, V as shouldThrowError, W as useQueryClient, u as useInternetIdentity, Y as createActorWithConfig } from "./index-vju8O4pi.js";
...
function useSearchTasks(searchTerm) {
  const { actor, isFetching } = useActor();
  const { identity } = useInternetIdentity();
  return useQuery({
...
export {
  useAllProjects as a,
  useAllGoals as b,
  useAllJournalEntries as c,
  useCreateTask as d,
  useToggleTaskCompletion as e,
  useDeleteTask as f,
  useUpdateTask as g,
  useCreateGoal as h,
  useUpdateGoal as i,
  useDeleteGoal as j,
  useCreateJournalEntry as k,
  useUpdateJournalEntry as l,
  useDeleteJournalEntry as m,
  useCreateProject as n,
  useUpdateProject as o,
  useDeleteProject as p,
  useSearchTasks as q,
  useAllTasks as u
};
