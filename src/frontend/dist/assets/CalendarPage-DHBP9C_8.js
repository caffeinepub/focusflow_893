import { c as createLucideIcon, R as React, r as reactExports, j as jsxRuntimeExports, a as cn, b as buttonVariants, B as Button$1, u as useInternetIdentity, m as motion, C as CalendarDays, L as LogIn } from "./index-KUZIGbRE.js";
import { B as Badge } from "./badge-CPHrWUW1.js";
import { C as ChevronLeft } from "./chevron-left-2rETL99G.js";
import { C as ChevronRight } from "./chevron-right-D8MxoVYZ.js";
import { C as ChevronDown } from "./chevron-down-loKMe_FN.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-Bmpqtthb.js";
import { S as Skeleton } from "./skeleton-Cj9O6Ive.js";
import { u as useAllTasks } from "./useQueries-DdSgPhXx.js";
import { C as Clock } from "./clock-B8iog8SF.js";
import { C as CircleCheck } from "./circle-check-CqAokQVe.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: cn(
        ...
        modifiers.disabled && "text-muted-foreground opacity-50 pointer-events-none",
        className
      ),
      ...props,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children }),
        hasTask && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: cn(
...
function CalendarTaskItem({
  ...
  const ocid = `calendar.task.item.${index + 1}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 mt-0.5", children: task.completed ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: "w-4 h-4 text-muted-foreground group-hover:text-foreground transition-colors" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          task.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 truncate", children: task.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
...
function CalendarPage() {
  ...
  const [month, setMonth2] = reactExports.useState(/* @__PURE__ */ new Date());
  const tasksByDate = reactExports.useMemo(() => {
  ...
  const datesWithTasks = reactExports.useMemo(
    () => new Set(tasksByDate.keys()),
    [tasksByDate]
  );
  const selectedDateTasks = reactExports.useMemo(() => {
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center h-full min-h-[60vh] px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "max-w-sm",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-primary/15 flex items-center justify-center mx-auto mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-8 h-8 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-2", children: "Calendar View" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 leading-relaxed", children: "Sign in to see your tasks on a calendar and stay on top of deadlines." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 max-w-6xl mx-auto", "data-ocid": "calendar.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mb-8",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl md:text-3xl font-bold text-foreground", children: "Calendar" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: "View and manage tasks by due date" })
        ]
      }
    ),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-80 w-full max-w-sm rounded-xl" }),
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Calendar,
              {
                mode: "single",
                ...
                components: {
                  DayButton: (props) => {
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsx(DotDayButton, { ...props, hasTask });
                  }
                },
                classNames: {
                  button_previous: cn(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sr-only", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "data-ocid": "calendar.prev_month.button" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "data-ocid": "calendar.next_month.button" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Card,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: selectedDateTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex flex-col items-center justify-center py-14 text-center",
                    "data-ocid": "calendar.empty_state",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-muted/60 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-6 h-6 text-muted-foreground" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No tasks due" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: selectedDate ? "Select another day or add tasks with a due date." : "Select a day to see tasks." })
                    ]
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: selectedDateTasks.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarTaskItem, { task, index: i }, task.id)) }) })
              ]
            }
          )
        ]
    ...
    !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-5 rounded-md bg-accent inline-block" }),
            "Today"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-5 rounded-md bg-primary inline-block" }),
            "Selected"
          ] })
        ]
      }
